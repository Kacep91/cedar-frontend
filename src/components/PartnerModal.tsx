...
export const tradeTypes = [
  {
    label: (
      <>
        Собирать и сдавать дикоросы <br /> на заготовительный пункт
      </>
    ),
  ...
  },
  {
    label: (
      <>
        Организовать заготовительный
        <br /> пункт по сбору дикоросов
      </>
    ),
  ...
  },
  {
    label: (
      <>
        Участвовать как производитель
        <br /> органической продукции
      </>
    ),
    value: "participation",
  },
  ...
  },
  {
    label: (
      <>
        Не определился, но интересуюсь
        <br /> этой темой и прошу направлять
      </>
    ),
    value: "dontKnow",
  },
