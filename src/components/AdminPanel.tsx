...
export const AdminPanel = () => {
  ...
  const deleteItem = (item: { id: string | null; name: string }) => {
    ...
    return axios
      .delete(`https://siberia-organic.com:3000/goods/${item.id}`)
      .then(() => {
  ...
  const deleteItemRecipe = (item: { id: string | null; name: string }) => {
    ...
    return axios
      .delete(`https://siberia-organic.com:3000/recipes/${item.id}`)
      .then(() => {
  ...
  const deleteItemSlide = (item: { id: string | null; name: string }) => {
    ...
    return axios
      .delete(`https://siberia-organic.com:3000/slides/${item.id}`)
      .then(() => {
      ...
      axios
        ...
        .then(async (res) => {
          ...
          if (recipiesFormData.id && alreadyLoadedData) {
            axios
              .put(
                `https://siberia-organic.com:3000/recipes/${recipiesFormData.id}`,
                object,
              )
              .then((response) => {
            ...
            axios
              .post("https://siberia-organic.com:3000/recipes", object)
              .then((response) => {
                console.log(response.data);
                toast.current?.show({
                  severity: "info",
      ...
      for (const item of files) {
        try {
          ...
          const response = await axios.post(
            "https://siberia-organic.com:3000/slides",
            object,
          );
          console.log(response.data);
          toast.current?.show({
