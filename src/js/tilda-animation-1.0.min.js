...
function t_animate__animateChainItemsOnScroll(t, e) {
  ...
  for (var l = 0; l < a.length; l++) {
    ...
    var m = 0.16 * n + o + s;
    (c.style.transitionDelay = m + "s"),
      c.classList.remove("t-animate_wait"),
      c.classList.add("t-animate_started"),
      c.setAttribute("data-animate-start-time", Date.now() + 1e3 * m),
      c[0] === a[a.length - 1] && t_animate__checkSectionButtonAnimation(t, m),
      +_ == +r && n++,
      a.splice(l, 1),
...
function t_animate__animateNumbers(e) {
  ...
  var a,
    ...
    _ =
      ((t = Array.prototype.filter.call(t, function (t) {
        return !t.classList.contains(".t-animate__number");
      })).length && (c = t[0].getAttribute("style") || ""),
      []),
    m = null,
    u =
      (l &&
  ...
  _[0] &&
    ...
    (s = setInterval(function () {
      var t;
      (i += n / 108),
        (o = f ? (Math.round(i) / r).toFixed(u) + "" : Math.floor(i) + ""),
  ...
  t.forEach(function (t) {
    ...
    t_animate__setCustomAnimSettings(t, e, i),
      e < a &&
        ...
        "animatednumber" === t_animate__getAttrByResBase(t, "style") &&
          t_animate__animateNumbers(t)),
      a <= e && t.classList.add("t-animate_wait");
  });
}
...
function t_animate__assignOrderedElemsDelay(t, e) {
  ...
  e.length &&
    ...
    (e.length ||
      ...
      l.length) &&
      c.length &&
      ((a += +t_animate__getAttrByResBase(c[0], "delay")),
...
function t_animate__getAttrByResBase(t, e) {
  ...
  return "y" !== (n ? n.getAttribute("data-animate-mobile") : null)
