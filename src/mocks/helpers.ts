export const randElements = <T>(arr: T[], count: number) => {
...
export const categories = [
  {
    ...
    price: "Бесплатно от 3500 рублей",
  },
  {
    name: "Пункт выдачи",
    text: "Срок доставки: 2-5 дней",
    price: "Бесплатно от 4000 рублей",
  },
  {
    name: "Курьером до двери",
    text: "Срок доставки: 1-5 дней",
    price: "Бесплатно от 40000 рублей",
  },
];
